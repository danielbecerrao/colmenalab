...
describe('DiseasesController', () => {
  ...
  describe('findOne', () => {
    it('should return a Disease when a valid ID is provided', async () => {
      jest.spyOn(service, 'findOne').mockResolvedValue(mock);

      const dto: FindOneDiseaseDto = new FindOneDiseaseDto();
